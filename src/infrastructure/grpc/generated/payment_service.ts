...
export const PaymentServiceService = {
  ...
  createProviderSession: {
    ...
    requestDeserialize: (value: Buffer): CreateProviderSessionRequest =>
      CreateProviderSessionRequest.decode(value),
    ...
    responseDeserialize: (value: Buffer): CreateProviderSessionResponse =>
      CreateProviderSessionResponse.decode(value),
  },
  resolvePayment: {
...
export interface PaymentServiceServer extends UntypedServiceImplementation {
  ...
  createProviderSession: handleUnaryCall<
    CreateProviderSessionRequest,
    CreateProviderSessionResponse
  >;
